...
const CONNECTOR_GROUPS = [
  { title: 'Commerce', key: 'commerce', items: [
    ...
    { id: 'walmart', name: 'Walmart', icon: '🏬', color: '#0071DC', hasOAuth: false, status: 'soon' },
    ...
    { id: 'faire', name: 'Faire', icon: '🏪', color: '#FF6B35', hasOAuth: false, status: 'soon' },
    { id: 'mercari', name: 'Mercari', icon: '🔴', color: '#E24444', hasOAuth: false, status: 'soon' },
    { id: 'poshmark', name: 'Poshmark', icon: '👗', color: '#C12B5B', hasOAuth: false, status: 'soon' },
  ]},
  { title: 'Social Media', key: 'social', items: [
    ...
    { id: 'youtube', name: 'YouTube', icon: '▶️', color: '#FF0000', hasOAuth: true, status: 'live' },
    { id: 'whatsapp', name: 'WhatsApp', icon: '💬', color: '#25D366', hasOAuth: true, status: 'live' },
    { id: 'threads', name: 'Threads', icon: '🔗', color: '#000000', hasOAuth: true, status: 'live' },
    { id: 'linkedin', name: 'LinkedIn', icon: '💼', color: '#0077B5', hasOAuth: false, status: 'soon' },
    { id: 'reddit', name: 'Reddit', icon: '🤖', color: '#FF4500', hasOAuth: false, status: 'soon' },
    { id: 'discord', name: 'Discord', icon: '🎮', color: '#5865F2', hasOAuth: false, status: 'soon' },
  ]},
