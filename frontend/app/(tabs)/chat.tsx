...
const AGENTS = [
  ...
  { type: 'walmart', name: 'Walmart', icon: '🏬', cat: 'commerce' },
  { type: 'faire', name: 'Faire', icon: '🏪', cat: 'commerce' },
  { type: 'mercari', name: 'Mercari', icon: '🔴', cat: 'commerce' },
  { type: 'poshmark', name: 'Poshmark', icon: '👗', cat: 'commerce' },
  // Social
  ...
  { type: 'youtube', name: 'YouTube', icon: '▶️', cat: 'social' },
  { type: 'whatsapp', name: 'WhatsApp', icon: '💬', cat: 'social' },
  { type: 'threads', name: 'Threads', icon: '🔗', cat: 'social' },
  { type: 'linkedin', name: 'LinkedIn', icon: '💼', cat: 'social' },
  { type: 'reddit', name: 'Reddit', icon: '🤖', cat: 'social' },
  { type: 'discord', name: 'Discord', icon: '🎮', cat: 'social' },
  // Business
  { type: 'email', name: 'Email', icon: '📧', cat: 'business' },
  { type: 'crm', name: 'CRM', icon: '🤝', cat: 'business' },
  { type: 'marketing_suite', name: 'Marketing', icon: '📣', cat: 'business' },
...
export default function ChatScreen() {
  ...
  const suggestions: Record<string, string[]> = {
    ...
    youtube: ['Plan my YouTube content strategy', 'Write titles that get clicks', 'Optimize my video descriptions'],
    whatsapp: ['Set up my WhatsApp Business catalog', 'Create quick reply templates', 'Plan a broadcast campaign'],
    threads: ['Write 5 Threads posts for my brand', 'What content works on Threads?', 'Cross-post strategy from IG'],
    linkedin: ['Write a thought leadership post', 'Optimize my company page', 'Plan B2B content for the week'],
    reddit: ['Which subreddits fit my brand?', 'Plan an authentic Reddit strategy', 'Draft an AMA outline'],
    discord: ['Design my community server structure', 'Write a welcome message', 'Plan weekly community events'],
